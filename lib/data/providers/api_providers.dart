...
final apiClassesProvider = FutureProvider.autoDispose<List<ClassModel>>((
  ref,
) async {
...
final apiStudentsProvider = FutureProvider.autoDispose
    .family<List<StudentModel>, String?>((ref, className) async {
...
final apiTeachersProvider = FutureProvider.autoDispose<List<TeacherModel>>((
  ref,
) async {
...
final apiNoticesProvider = FutureProvider.autoDispose<List<NoticeModel>>((
  ref,
) async {
...
final apiAssignmentsProvider = FutureProvider.autoDispose
    .family<List<AssignmentModel>, String?>((ref, className) async {
...
final apiFeesProvider = FutureProvider.autoDispose
    .family<List<FeeModel>, String?>((ref, studentId) async {
...
final apiFeeStatsProvider = FutureProvider.autoDispose<Map<String, dynamic>>((
  ref,
) async {
  final service = ref.watch(feesApiServiceProvider);
...
final apiResultsProvider = FutureProvider.autoDispose
    .family<List<ResultModel>, String?>((ref, studentId) async {
...
final apiStudentDashboardProvider = FutureProvider.autoDispose
...
final apiTeacherDashboardProvider = FutureProvider.autoDispose
    .family<Map<String, dynamic>, String?>((ref, teacherId) async {
      final service = ref.watch(dashboardApiServiceProvider);
